...
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ehr-integration-epic-cerner-hl7/run.

export default function EhrIntegrationEpicCernerHl7Page() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ehr-integration-epic-cerner-hl7/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No EHR integration (Epic, Cerner, HL7)</h1>
