...
// v0 scaffold for: ML urgent-case prioritization with radiologist alerts
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-ml-urgent-case-prioritization-radiologist/run.

export default function MlUrgentCasePrioritizationRadiologistPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-ml-urgent-case-prioritization-radiologist/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>ML urgent-case prioritization with radiologist alerts</h1>
