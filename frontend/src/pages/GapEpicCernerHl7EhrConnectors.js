...
// v0 scaffold for: Epic, Cerner, and HL7 EHR connectors
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-epic-cerner-hl7-ehr-connectors/run.

export default function EpicCernerHl7EhrConnectorsPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-epic-cerner-hl7-ehr-connectors/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Epic, Cerner, and HL7 EHR connectors</h1>
