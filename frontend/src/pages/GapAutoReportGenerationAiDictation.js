...
// v0 scaffold for: Auto-report generation via AI dictation from findings
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-auto-report-generation-ai-dictation/run.

export default function AutoReportGenerationAiDictationPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-auto-report-generation-ai-dictation/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Auto-report generation via AI dictation from findings</h1>
